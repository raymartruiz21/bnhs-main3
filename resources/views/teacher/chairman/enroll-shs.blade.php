    ...
    <div class="section-body">
        <div class="container-fluid">
                ...
                <div class="col-12">
                    <div class="row justify-content-between">
                        <div class="col-lg-5 col-md-8">
                            <p style="font-size: 25px;"><i class="far fa-address-card"></i>&nbsp;&nbsp;Enrolle's Today [ Grade {{ Auth::user()->chairman_info->grade_level }} Student ]</p>
                        </div>
            ...
            {{-- <div class="col-12">
                <div class="row justify-content-between">
                    <div class="col-lg-5 col-md-8">
                        <h2 class="section-title">Enrolle's Today [ Grade {{ Auth::user()->chairman_info->grade_level }} Student ]
                        </h2>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <form id="massSectioningForm" >
                                    <div class="col-lg-2 mb-3 mt-2 ml-2">
                                        <div class="input-group">
                                    ...
                                    <table class="table table-striped" style="font-size: 13px;" id="gradeElevenTable">
                                        <thead>
                                            <tr>
