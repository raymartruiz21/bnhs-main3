...
$("#holidayForm").submit(function (e) {
    ...
    $.ajax({
        ...
        .done(function (response) {
            ...
            getToast("success", "Successfully", " added new Holiday");
        ...
        { data: "description" },
        {
            ...
            render: function (data) {
                ...
                <div class="btn-group" role="group" aria-label="Basic example">
                    <button class="btn btn-sm btn-info text-white btnEdit btnload_${data.id}" value="${data.id}">Edit</button>
                    <button class="btn btn-sm btn-danger text-white btnDelete btnDLoad_${data.id}" value="${data.id}">Delete</button>
                </div>
                `;
            },
        },
    ...
    $.ajax({
        ...
        .done(function (response) {
            $(".btnDLoad_" + id)
                .html("Edit")
                .attr("disabled", false);
                getToast("success", "Successfully", " deleted Holiday");
            tableHoliday.ajax.reload();
        })
        .fail(function (jqxHR, textStatus, errorThrown) {
            $(".btnDLoad_" + id)
