                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    <button type="button" style="font-size:12px" class="btn btn-sm btn-info text-white pl-3 pr-3 editSection editSec_${
                                        val.id
                                    }" id="${val.id}">Edit</button>
                                    <button type="button" style="font-size:12px" class="btn btn-sm btn-danger text-white deleteSection deleteSec_${
                                        val.id
