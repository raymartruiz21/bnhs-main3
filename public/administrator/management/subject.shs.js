    ...
    columns: [
        ...
        // { data: "prerequisite" },
        {
            ...
            render: function (data) {
                ...
                <button type="button" class="btn btn-sm btn-danger text-white deleteSHS deleteSHS_${data.id}  pt-2 pb-2 pl-4 pr-4" id="${data.id}">
                    Delete
                    </button>
                    <button type="button" class="btn btn-sm btn-info text-white editSHS editSHS_${data.id} pt-2 pb-2  pl-4 pr-4" id="${data.id}">
                         Edit
                    </button>
                    </div>
                    `;
