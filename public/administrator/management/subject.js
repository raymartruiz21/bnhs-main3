                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Basic example">
                                    ...
                                    <button type="button" style="font-size:12px" class="btn btn-sm btn-danger text-white pb-2 pt-2 pl-3 pr-3 deleteSubject deleteSub_${
                                        val.id
                                    }" id="${val.id}">Delete</button>
                                    <button type="button" style="font-size:12px" class="btn btn-sm btn-info text-white pb-2 pt-2 pl-3 pr-3 editSubject editSub_${
                                        val.id
...
$("#subjectForm").submit(function (e) {
    ...
    $.ajax({
        ...
        .done(function (data) {
            ...
            getToast("success", "Successfully", "added one subject");
            cancelSubject.hide();
        })
        .fail(function (jqxHR, textStatus, errorThrown) {
            getToast("error", "Eror", errorThrown);
    ...
    if (confirm("Are you sure,Do you want delete this?")) {
        ...
        $.ajax({
            ...
            .done(function (response) {
                ...
                getToast("success", "Successfully", "deleted one subject");
