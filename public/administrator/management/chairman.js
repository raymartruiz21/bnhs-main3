                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="btn-group" role="group" aria-label="Basic example">
                                        <button type="button" style="font-size:12px" class="text-white btn btn-sm btn-info pl-3 pr-3 editchairman editCha_${
                                            val.id
                                        }" id="${val.id}">Edit</button>
                                        <button type="button" style="font-size:12px" class="text-white btn btn-sm btn-danger deletechairman deleteCha_${
                                            val.id
