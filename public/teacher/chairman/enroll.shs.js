                ...
                if (data.enroll_status == "Dropped") {
                   ...
                   ${
                       data.enroll_status == "Enrolled"
                           ? `<button type="button" class="btn btn-sm btn-primary text-white  cEdit btnEdit_${data.id} pt-0 pb-0 pl-5 pr-5 " id="${data.id}">
                           <i class="fas fa-edit"></i>
               </button>`
                           : `<button type="button" class="btn btn-sm btn-danger text-white cDelete btnDelete_${data.id}  pt-0 pb-0 pl-4 pr-4" id="${data.id}">
