...
class SubjectSeeder extends Seeder
{
    ...
    public function run()
    {
        $subjects = [
            ...
            [
                'indicate_type' => 'Core',
                'subject_code' => 'Core 11',
                'descriptive_title' => 'Physical Science',
            ],
            [
                'indicate_type' => 'Core',
                'subject_code' => 'GM-02',
            ...
            [
                ...
                'indicate_type' => 'Core',
                'subject_code' => 'PE-1',
                'descriptive_title' => 'Physical Education and Health 1',
            ],
            [
                'grade_level' => '11',
                'indicate_type' => 'Core',
                'subject_code' => 'PE-2',
                'descriptive_title' => 'Physical Education and Health 2',
            ],
            [
                'grade_level' => '12',
                'indicate_type' => 'Core',
                'subject_code' => 'PE-3',
                'descriptive_title' => 'Physical Education and Health 3',
            ],
            [
                'grade_level' => '12',
                'indicate_type' => 'Core',
                'subject_code' => 'PE-4',
                'descriptive_title' => 'Physical Education and Health 4',
            ],
            [
                'indicate_type' => 'Core',
